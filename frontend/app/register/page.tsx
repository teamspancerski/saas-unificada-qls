...
import { Mail, Lock, User, PlusCircle, Chrome, Zap } from 'lucide-react';
...
export default function RegisterPage() {
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-slate-200 font-sans flex items-center justify-center p-6 selection:bg-[#00ff88]/30 overflow-hidden relative">
      {/* Background Glows */}
      <div className="absolute top-1/4 -right-1/4 w-1/2 h-1/2 bg-[#00ff88]/5 rounded-full blur-[160px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 -left-1/4 w-1/2 h-1/2 bg-[#00d4ff]/5 rounded-full blur-[160px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-[480px] relative z-10">
        ...
        <div className="bg-white/[0.03] border border-white/10 backdrop-blur-2xl rounded-[2.5rem] p-10 shadow-2xl">
          <h2 className="text-xl font-bold mb-8 text-center">Registrar Nova Conta</h2>

          <form className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-4">Nome Completo</label>
              <div className="relative group">
                <User className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-[#00ff88] transition-colors" size={18} />
                <input
                  type="text"
          ...
          <div className="relative my-10 flex items-center justify-center">
            ...
            <span className="relative px-4 bg-[#0e0e0e] text-[10px] font-black text-slate-600 uppercase tracking-widest">Ou registrar com</span>
          </div>
          ...
          <p className="mt-10 text-center text-xs font-medium text-slate-500">
            Já possui uma conta? {' '}
            <Link href="/login" className="text-[#00ff88] font-black hover:underline underline-offset-4">Entrar Agora</Link>
          </p>
        </div>
